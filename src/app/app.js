      ...
      function config(
        ...
        $stateProvider
          .state('frontend', {
            ...
            views: {
              main: {
                templateUrl: '/frontend/core/layout/partials/main.html',
                controller: function() {}
              }
            }
          })
        ...
        $stateProvider
          .state('frontend.admin', {
            views: {
              ...
              'sidebar@frontend': {
                templateUrl: '/frontend/core/layout/partials/sidebar.html',
  ...
  angular.module('frontend')
    .run([
      ...
      function run(
        ...
        // Set App Name
        $rootScope.appName = 'Angular';

        // Set template through root scope
        $rootScope.template = {
