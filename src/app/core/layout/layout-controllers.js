...
(function() {
  ...
  /**
   * Generic sidebar controller for application layout.
   * This contains all necessary logic which is used on application
   * sidebar section. Basically this contains following:
   *
  ...
  angular.module('frontend.core.layout')
    .controller('SidebarController', [
      function controller() {
        // TODO: add notifications and sidebar-related stuff
      }
    ])
  ;
